...
public class PcMod {
    ...
    public enum Socket { LGA1700("LGA1700"), AM4("AM4"), AM5("AM5");
        public final String name; Socket(String n) { this.name = n; }
    }
    public enum RamType { DDR4("DDR4"), DDR5("DDR5");
        public final String name; RamType(String n) { this.name = n; }
    }
    public enum StorageType { HDD("HDD"), SSD("SSD"), NVME("NVMe");
        public final String name; StorageType(String n) { this.name = n; }
    }
    public enum PsuCert { BRONZE("80+ Bronze"), GOLD("80+ Gold"), PLATINUM("80+ Platinum"), TITANIUM("80+ Titanium");
        public final String name; PsuCert(String n) { this.name = n; }
    }
